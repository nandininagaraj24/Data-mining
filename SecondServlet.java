...
private String web_page_name="b.html";

@Override
	public void init(ServletConfig config) throws ServletException 
		{

			System.out.println("hi iam inm init method of second servlet **************************");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 		{
			try
			{
				hs=request.getSession(true);
		 		...
		 		SecondServlet fs=new  SecondServlet();
				...
				/* getting the parameters of first web page*/
	 			...
	 			book_selected= request.getParameter("SQL_list");
				...
				webcount=wca.getCount("sql_page",response);
				webcount=webcount+1;
				...
				uwc.updatingWebCount(webcount,"sql_page");




				/* forwarding to bank access page */
			...
			{
				out.println("THIS IS SECOND SERVLET AND THERE IS AN EXCEPTION:"+"\t"+e);
			}
