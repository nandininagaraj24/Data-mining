...
private String web_page_name="e.html";

@Override
	public void init(ServletConfig config) throws ServletException 
		{
			
			System.out.println("hi iam inm init method of fifth servlet **************************");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 		{
			try
			{
				...
				/* getting the parameters of first web page*/
	 			...
	 			book_selected= request.getParameter("food_list");
				...
				webcount=wca.getCount("food_page",response);
				webcount=webcount+1;
				...
				uwc.updatingWebCount(webcount,"food_page");
			...
			{
				out.println("THIS IS FIFTH SERVLET AND THERE IS AN EXCEPTION:"+"\t"+e);
			}
		...
		public void destroy( ) 
		{
			...
			this.totaltime=0;
			System.out.println("hi iam in destroy method of fifth servlet **************************");
