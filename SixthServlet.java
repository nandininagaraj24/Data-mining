...
private String web_page_name="f.html";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 		{
			try
			{
				...
				/* getting the parameters of first web page*/
	 			...
	 			book_selected= request.getParameter("sports_list");
				...
				webcount=wca.getCount("sports_page",response);
				webcount=webcount+1;
				...
				uwc.updatingWebCount(webcount,"sports_page");
			...
			{
				out.println("THIS IS SIXTH SERVLET AND THERE IS AN EXCEPTION:"+"\t"+e);
			}
		...
		public void destroy( ) 
		{
			...
			this.totaltime=0;
			System.out.println("hi iam in destroy method of sixth servlet **************************");
