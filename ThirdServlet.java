...
public class ThirdServlet extends HttpServlet
 {
	...
	private String web_page_name="c.html";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
 		{
			try
			{
				hs=request.getSession(true);
		 		...
		 		ThirdServlet fs=new  ThirdServlet();
				...
				/* getting the parameters of first web page*/
	 			...
	 			book_selected= request.getParameter("C_list");
				...
				webcount=wca.getCount("c_page",response);
				webcount=webcount+1;
				...
				uwc.updatingWebCount(webcount,"c_page");

				/*dispatching it to account html page*/
			...
			{
				out.println("THIS IS THIRD SERVLET AND THERE IS AN EXCEPTION:"+"\t"+e);
			}
		...
		public void destroy( ) 
		{
			...
			this.totaltime=0;
			System.out.println("hi iam in destroy method of third servlet **************************");
